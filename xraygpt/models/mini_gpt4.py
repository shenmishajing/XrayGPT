...
from transformers import (  # for imprgpt eval
    LlamaTokenizer,
    StoppingCriteria,
...
class MiniGPT4(Blip2Base):
    ...
    def test(
        ...
        stop_words_ids = [
            torch.tensor([835]).to(samples["image"].device),
        ...
        embs = self.get_context_emb(samples["caption"][0], img_embeds)
    ...
    def get_context_emb(self, prompt, img):
        prompt_segs = prompt.split("<image>")
        img_list = [img]
