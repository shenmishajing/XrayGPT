...
from xraygpt.datasets.datasets.iuxray_dataset import IUXrayDataset
...
class IUXrayCBuilder(BaseDatasetBuilder):
    train_dataset_cls = IUXrayDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/iu_xray/defaults.yaml"}
    ...
    def build_datasets(self):
        ...
        datasets["train"] = dataset_cls(
            ...
            ann_paths=[os.path.join(storage_path, "qa/qa.jsonl")],
